    ...
    "inline-flex items-center justify-center gap-2 uppercase font-bold border-2 border-black transition-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0 font-[family-name:var(--font-rs-bold)] cursor-pointer",
    {
        variants: {
            variant: {
                ...
                ghost: "border-rs-brown-medium bg-rs-brown-dark/70 text-rs-brown-light [text-shadow:_1px_1px_0_rgba(0,0,0,0.85)] shadow-[inset_1px_1px_0_rgba(255,255,255,0.08),inset_-1px_-1px_0_rgba(0,0,0,0.55)] hover:text-rs-yellow active:shadow-[inset_-1px_-1px_0_rgba(255,255,255,0.08),inset_1px_1px_0_rgba(0,0,0,0.7)]",
                link: "border-transparent bg-transparent text-rs-orange [text-shadow:_1px_1px_0_rgba(0,0,0,0.9)] shadow-none underline-offset-4 hover:text-rs-yellow hover:underline",
                // Compact inline stepper (−1 / +1): beveled brown-medium fill +
                // gold text, matching the "classic" variant's raised-bevel
                // pattern but sized/toned for rapid repeated clicks.
                stepper:
                    "bg-rs-brown-medium text-rs-gold [text-shadow:_1px_1px_0_rgba(0,0,0,0.9)] shadow-[inset_1px_1px_0_rgba(255,255,255,0.12),inset_-1px_-1px_0_rgba(0,0,0,0.65)] hover:text-rs-yellow active:shadow-[inset_-1px_-1px_0_rgba(255,255,255,0.1),inset_1px_1px_0_rgba(0,0,0,0.7)] disabled:bg-rs-brown-dark disabled:text-rs-brown-light disabled:opacity-100",
            },
            size: {
                sm: "h-9 px-3 text-sm",
